...
async function main() {
  ...
  // Yale LUX object ids are UUIDs — keep as-is.
  ...
  document.title = `${artwork.title} · Yale`;
  ...
  container.innerHTML = `
    <div class="grid md:grid-cols-2 gap-8">
      <div>
        ...
        ${a.imageId
          ? `<button type="button" id="deepzoom-btn" class="mt-4 w-full bg-blue-900 text-white py-2.5 rounded font-medium">View in high-res</button>`
          : ""}
      </div>
      <div>
