...
async function main() {
  ...
  // Harvard object ids are numeric — keep as-is.
  ...
  document.title = `${artwork.title} · Harvard`;
  ...
  container.innerHTML = `
    <div class="grid md:grid-cols-2 gap-8">
      <div>
        ...
        ${a.imageId
          ? `<button type="button" id="deepzoom-btn" class="mt-4 w-full bg-red-800 text-white py-2.5 rounded font-medium">View in high-res</button>`
          : ""}
      </div>
      <div>
