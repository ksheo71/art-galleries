...
/**
 * Open a pan-and-zoom viewer on the given image URL.
 * Uses OpenSeadragon's "simple image" mode since Met provides direct
 * image URLs (not IIIF manifests).
 */
export async function openViewer(imageUrl) {
  if (!imageUrl) return;
